            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    <form action="{{ route('tareas.store') }}" method="post" class="max-w-xl mx-auto">
                        ...
                        <div class="mb-5">
                            <label for="fecha_mail" id="fecha_mail" class="block mb-2 text-sm font-medium text-gray-900 ">Seleccione la
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if(selectedOption.value === "PREVENTIVO"){
            ...
            document.querySelector("#fecha_mail").innerHTML = `Seleccione la fecha del preventivo <p class="inline-block text-red-500">*</p>`;
        }else{
            divsOcultar.forEach(element => {
                element.classList.remove("hidden");
            });
            document.querySelector("#fecha_mail").innerHTML = `Seleccione la fecha del mail <p class="inline-block text-gray-500">(opcional)</p>`;
        }
    });
